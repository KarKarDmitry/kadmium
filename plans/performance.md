...
**Статус:** ✅ Acceptable (согласовано 2026-09-10). Для типичных запросов (1-2 таблицы) overhead пренебрежим; кеширование графа добавило бы инвалидацию по любой мутации AST — не стоит сложности.
